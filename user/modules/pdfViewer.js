    ...
    <div class="editorParamsToolbarContainer">
      <div class="editorParamsSetter">
        <label
          ...
          data-l10n-id="editor_free_text_font_color"
          >Font Color</label
        >
        <input
          type="color"
      ...
      <div class="editorParamsSetter">
        <label
          ...
          class="editorParamsLabel"
          data-l10n-id="editor_free_text_font_size"
          >Font Size</label
        >
        <input
          type="range"
    ...
    <div class="editorParamsToolbarContainer">
      <div class="editorParamsSetter">
        <label
          for="editorInkColor"
          class="editorParamsLabel"
          data-l10n-id="editor_ink_line_color"
          >Line Color</label
        >
        <input
          type="color"
      ...
      <div class="editorParamsSetter">
        <label
          ...
          class="editorParamsLabel"
          data-l10n-id="editor_ink_line_thickness"
        ...
        <div id="toolbarViewerRight">
          ...
          >
            <button
              ...
              aria-checked="true"
              tabindex="36"
              data-l10n-id="editor_none"
            >
              <span data-l10n-id="editor_none_label"
...
<div style="top: 100px" id="loading">
      <div class="spinner">
        <div class="rect1"></div>
        <div class="rect2"></div>
        <div class="rect3"></div>
